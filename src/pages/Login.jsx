                ...
                <div className='row'>
                    ...
                    <div className="col-md-6 mt-5 p-4">
                        <div className='text-center border rounded text-white d-flex justify-content-center '>
                            <div>
                                <h1 className='mt-3' style={{ color: '#ff1cb3' }}>Login</h1>
                                ...
                                <Button variant="outline-light" className='btn m-3 ps-5 pe-5 rounded' style={{ color: '#ff1cb3' }}>Login</Button>

                                <h6 className='mb-4 '>forgot password? / <Link to={'/Singup'} className='text-white text-decoration-none'>Sing up</Link></h6>
                            </div>
